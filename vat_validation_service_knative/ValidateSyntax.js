...
module.exports = function validateSyntax(toCheck) {
    ...
    vatexp
        ...
        .map(regexp => {
            ...
            resp.countryCode = cCode;
            resp.vatNumber = cNumber;

            var isValid = countryVatCheckers[`${cCode}VATCheckDigit`](cNumber);

            resp.valid = isValid
        })
        .reduce((memo, resp) => resp, false);
